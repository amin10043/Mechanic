...
public class DisplayPersonalInformationFragment extends Fragment implements GetAsyncInterface, AsyncInterface {
...
// // Expandview = (ExpandableListView) rootView.findViewById(R.id.items);
//
// HashMap<String, List<PersonalData>> listDataChild = new HashMap<String,
///////////////// List<PersonalData>>();
//
// ArrayList<String> parentItems = new ArrayList<String>();
//
