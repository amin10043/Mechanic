...
public class CreateAgencyService extends Fragment implements AsyncInterface, SaveAsyncInterface, ProvinceCityInterface {
	...
	public CreateAgencyService(int mainBrandId, int agencyService, int cityId) {
	...
	private void imagesClick() {
		...
		btnHeader.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				getActivity().startActivityFromFragment(CreateAgencyService.this, i, headerGallery);
		...
		btnProfile.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				getActivity().startActivityFromFragment(CreateAgencyService.this, i, RESULT_LOAD_IMAGE);
			}
		});
		...
		btnFooter.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				getActivity().startActivityFromFragment(CreateAgencyService.this, i, footerGallery);
			}
		});
	}
		...
		btnSave.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (nameValue.equals("")) {
					...
					date.delegate = CreateAgencyService.this;
					date.execute("");
	...
	public void processFinish(String output) {
		...
		if (util.checkError(output) == false) {
			...
			try {
				...
				DBAdapter.createNewAgencyService(agencyId, nameValue, phoneValue, emailValue, faxValue,
						descriptionValue, catalog, price, pdf, addressValue, mobileValue, faceBook, instagram, linkedIn,
						google, websiteValue, twiiter, currentUser.getId(), mainBrandId, agencyService, serverDate);

				DBAdapter.close();

				SavingImage3Picture savingImage = new SavingImage3Picture(getActivity());
				savingImage.delegate = CreateAgencyService.this;
				...
				saving.delegate = CreateAgencyService.this;
				...
				params.put("ObjectId", String.valueOf(mainBrandId));
