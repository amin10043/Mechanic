...
public class Province3ListAdapter extends ArrayAdapter<Province> {
	...
	public Province3ListAdapter(Context context, int resource, List<Province> objact, int mainObjectId) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		convertView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				trans.replace(R.id.content_frame, new City3Fragment(allItems , mainObjectId));
