...
public class SharedFileAdapter extends ArrayAdapter<String> {
	...
	public SharedFileAdapter(Context context, int resource, List<String> nameMusic, List<String> size) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		convertView = inflater.inflate(R.layout.row_file_shared, null);
