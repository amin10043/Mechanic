...
import com.project.mechanic.service.MyTransport;

//import org.ksoap2.transport.HttpTransportSE;
//import org.ksoap2.transport.HttpTransportSE;

public class GetDatesImagesObject extends AsyncTask<String, Integer, String> {
	...
	public DateImagesInformationObject delegate = null;

	public GetDatesImagesObject(Context context) {
	}
	...
	protected void onPostExecute(String res) {
		...
		if (delegate != null)
			delegate.resultDateImagesObject(res);
	}
}
