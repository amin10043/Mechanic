...
public class UsersFollowersServer extends AsyncTask<Map<String, String>, Integer, String> {
	...
	public UsersFollowersInterface delegate = null;

	public UsersFollowersServer(Context context) {
	}
	...
	protected void onPostExecute(String res) {
		...
		if (delegate != null)
			delegate.resultUserFollowers(res);
	}
