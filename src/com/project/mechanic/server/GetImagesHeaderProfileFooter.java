...
public class GetImagesHeaderProfileFooter extends
	...
	public HeaderProfileFooterImagesObject delegate = null;

	public GetImagesHeaderProfileFooter(Context context) {
	...
	protected void onPostExecute(List<byte[]> res) {
		...
		if (delegate != null)
			delegate.resultHeaderProfileFooterImages(res);
	}
