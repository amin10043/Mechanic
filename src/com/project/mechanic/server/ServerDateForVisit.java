...
public class ServerDateForVisit extends AsyncTask<String, Integer, String> {
	...
	public DateFromServerForVisit delegate = null;

	public ServerDateForVisit(Context context) {
