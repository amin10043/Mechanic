...
public class GetLikeInCommentServer extends AsyncTask<Map<String, String>, Integer, String> {
	...
	public GetLikeInCommetInterface delegate = null;

	public GetLikeInCommentServer(Context context) {
	}
	...
	protected void onPostExecute(String res) {
		...
		if (delegate != null)
			delegate.ResultLikeInCommentFromServer(res);
	}
