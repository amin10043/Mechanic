...
public class CountAgencyServiceServer extends
	...
	public CountAgencySerViceInterface delegate = null;

	public CountAgencyServiceServer(Context context) {
	}
	...
	protected void onPostExecute(String res) {
		...
		if (delegate != null)
			delegate.ResultCountAgency(res);
	}
