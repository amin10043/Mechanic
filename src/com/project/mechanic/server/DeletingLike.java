...
public class DeletingLike extends AsyncTask<Map<String, String>, Integer, String> {
	...
	public DeleteLikeFromServer delegate = null;

	public DeletingLike(Context context) {
