...
public class SavingLike extends AsyncTask<Map<String, String>, Integer, String> {
	...
	public LikeFromServer delegate = null;

	public SavingLike(Context context) {
