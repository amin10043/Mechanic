...
public class ServerDateForLike extends AsyncTask<String, Integer, String> {
	...
	public DateFromServerForLike delegate = null;

	public ServerDateForLike(Context context) {
