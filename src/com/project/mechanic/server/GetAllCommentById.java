...
public class GetAllCommentById extends AsyncTask<Map<String, String>, Integer, String> {
	...
	public GetAllCommentInterface delegate = null;

	public GetAllCommentById(Context context) {
	}
