...
public class GetSubAdminServer extends AsyncTask<Map<String, String>, Integer, String> {
	...
	public SubAdminInterface delegate = null;

	public GetSubAdminServer(Context context) {
	}
