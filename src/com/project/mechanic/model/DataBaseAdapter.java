...
public class DataBaseAdapter {
	...
	private String TablePostPhoto = "PostPhoto";
	...
	private String[] CommentInObject = { "Id", "Desk", "ObjectId", "UserId", "Date", "CommentId", "NumofLike",
			"NumofDisLike ", "Seen" };

	private String[] CommentInFroum = { "ID", "Desk", "FroumId", "UserId", "Date", "CommentId", "NumOfDislike",
			"NumOfLike", "Seen" };

	private String[] CommentInPost = { "ID", "Description", "PostId", "UserId", "Date", "CommentId", "Seen" };

	private String[] CommentInPaper = { "Id", "Desk", "PaperId", "UserId", "Date", "CommentId", "Seen" };
	...
	private String[] News = { "ID", "Title", "Description", "ServerDate", "Submit" };
	private String[] Object = { "ID", "Name", "Phone", "Email", "Fax", "Description", "Image1", "Image2", "Image3",
			"Image4", "Pdf1", "Pdf2", "Pdf3", "Pdf4", "Address", "CellPhone", "ObjectTypeId", "ObjectBrandTypeId",
	...
	private String[] Settings = { "Id", "IMEI", "ServerDate_Start_Object", "ServerDate_End_Object",
			"ServerDate_Start_News", "ServerDate_End_News", "ServerDate_Start_Paper", "ServerDate_End_Paper",
			"ServerDate_Start_Froum", "ServerDate_End_Froum", "ServerDate_Start_Anad", "ServerDate_End_Anad",
			"ServerDate_Start_Ticket", "ServerDate_End_Ticket", "ServerDate_Start_CommentInObject",
			"ServerDate_End_CommentInObject", "ServerDate_Start_CommentInFroum", "ServerDate_End_CommentInFroum",
			"ServerDate_Start_CmtInPaper", "ServerDate_End_CmtInPaper", "ServerDate_Start_LikeInPaper",
			"ServerDate_End_LikeInPaper", "ServerDate_Start_LikeInFroum", "ServerDate_End_LikeInFroum",
	...
	private String[] Ticket = { "Id", "Title", "Desc", "UserId", "Image", "date", "TypeId", "Name", "Email", "Mobile",
			...
			"Seen", "Submit", "seenBefore", "Day", "imagePath", "ImageServerDate", "CountView" };

	private String[] TicketType = { "ID", "desc" };

	private String[] Users = { "ID", "Name", "Email", "Password", "Phonenumber", "Mobailenumber", "Faxnumber",
			"Address", "Image", "ServiceId", "ServerDate", "Date", "Submit", "Admin", "ImageServerDate", "ImagePath",
			"ShowInfoItem", "BirthDay", "CityId" };

	// private String[] WorkmanType = { "ID", "Name" };
	private String[] NewsPaper = { "ID", "Name", "TypeId", "Url", "ServerDate", "HtmlString " };
	...
	private String[] likeInPost = { "Id", "PostId", "UserId", "IsLike", "Date", "ModifyDate", "CommentId" };

	private String[] commentInPost = { "Id", "Desc", "PostId", "UserId", "Date", "CommentId", "Seen" };

	private String[] AnadFooter = { "Id", "Image", "ObjectId", "Date", "TypeId", "Seen", "Submit", "ImageServerDate" };

	private String[] LikeinCommentPost = { "ID", "CommentId", "UserId", "IsLike", "Date" };
	private String[] extraSettings = { "Id", "Key", "Value" };
	...
	public void inserUserToDb(int id, String name, String email, String password, String phonenumber,
			String mobailenumber, String faxnumber, String address, byte[] image, int serviceid, String date,
	...
	public void insertAnadToDb(byte[] image, int objectId, String date, int tyoeId, int provinceId, int seen) {
	...
	public void inserUsernonpicToDb(int Id, String name, String email, String password, String phonenumber,
			String mobailenumber, String faxnumber, String address, int serviceid, String date, String BirthDay,
			int CityId) {
	...
	public void insertImageAddressToDb(String tableName, int id, String imageAddress, String imageDate) {

		ContentValues uc = new ContentValues();

		if (tableName.equals(TablePost)) {
			uc.put("Photo", imageAddress);
			uc.put("serverDate", imageDate);
		}
	...
	public void UpdateTicketToDb(int id, String title, String desc, byte[] image, String name, String date,
			String email, String phone, String fax, String mobile, int day) {
	...
	public void UpdateAllUserToDb(int id, String email, String password, String phonenumber, String mobailenumber,
			String faxnumber, String address, byte[] image) {
	...
	public void UpdateAllUserToDbNoPic(String name, int id, String email, String password, String phonenumber,
			String mobailenumber, String faxnumber, String address, String CheckInformation, String Birthday,
			int CityId) {
	...
	public void insertLikeInObjectToDb(int id, int UserId, int PaperId, String Date, int CommentId) {
	...
	public void insertHappyOrSadFromPageToDb(int id, int UserId, int ObjectId, String Date, int IsLike) {
	...
	public void insertLikeInFroumToDb(int id, int UserId, int FroumId, String Date, int CommentId) {
	...
	public void insertLikeInPostToDb(int id, int UserId, int PostId, String Date, int CommentId) {
	...
	public boolean isUserLikedFroum(int userId, int FroumID) {
		...
		Cursor curs = mDb.rawQuery("SELECT COUNT(*) AS NUM FROM " + TableLikeInFroum + " WHERE UserId= "
				+ String.valueOf(userId) + " AND FroumId=" + String.valueOf(FroumID), null);
		if (curs.moveToNext()) {
	...
	public boolean isUserLikedPost(int userId, int PostID) {
		Cursor curs = mDb.rawQuery("SELECT COUNT(*) AS NUM FROM " + TableLikeInPost + " WHERE UserId= "
				+ String.valueOf(userId) + " AND PostId=" + String.valueOf(PostID), null);
		if (curs.moveToNext()) {
			int number = curs.getInt(0);
			if (number > 0)
				return true;
	...
	public void insertLikeInPaperToDb(int id, int UserId, int PaperId, String Date) {
	...
	public boolean isUserLikedPaper(int userId, int paperId) {
		...
		Cursor curs = mDb.rawQuery("SELECT COUNT(*) AS NUM FROM " + TableLikeInPaper + " WHERE UserId= "
				+ String.valueOf(userId) + " AND PaperId=" + String.valueOf(paperId), null);
		if (curs.moveToNext()) {
			int number = curs.getInt(0);
			if (number > 0)
				return true;
	...
	public void insertCommentInFroumtoDb(int id, String description, int Froumid, int userid, String datetime,
			int commentid) {
	...
	public void insertCommentInPosttoDb(int id, String description, int Postid, int userid, String datetime,
			int commentid) {
	...
	public void insertCommentInPapertoDb(int id, String description, int Paperid, int userid, String datetime) {
	...
	public void insertCommentObjecttoDb(int id, String description, int Objectid, int userid, String datetime,
			int commentid) {
	...
	public void insertFroumtitletoDb(int id, String Title, String description, int userId, String date) {
	...
	public void insertPosttitletoDb(int id, /* String Title, */
			String description, int userId, String date, String ImageAdrress, int objectId) {
	...
	public void insertTickettoDbemptyImage(int id, String Title, String Desc, int userId, String date, int typeId,
			int provinceId, String uname, String uemail, String uphonnumber, String ufax, String uadress,
	...
	public void insertFavoritetoDb(int ObjectId, int userId, int IdTicket, int Type) {
	...
	public void insertPapertitletoDb(int id, String Title, String Context, int userID, String date) {
	...
	public ArrayList<City> getAllCity() {
		...
		City tempCity;
		while (cursor.moveToNext()) {
			tempCity = new City(cursor.getInt(0), cursor.getString(1), cursor.getInt(2), cursor.getInt(3));
			result.add(tempCity);
		}
		return result;
	}
	...
	public ArrayList<Object> getAllObject() {
		...
		Object tempObject;
		while (cursor.moveToNext()) {
			tempObject = new Object(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3),
					cursor.getString(4), cursor.getString(5), cursor.getBlob(6), cursor.getBlob(7), cursor.getBlob(8),
					null, cursor.getString(10), cursor.getString(11), cursor.getString(12), cursor.getString(13),
					cursor.getString(14), cursor.getString(15), cursor.getInt(16), cursor.getInt(17),
					cursor.getString(18), cursor.getString(19), cursor.getString(20), cursor.getString(21),
					cursor.getString(22), cursor.getString(23), cursor.getInt(24), cursor.getInt(25), cursor.getInt(26),
					cursor.getString(27), cursor.getInt(28), cursor.getInt(29), cursor.getInt(30), cursor.getInt(31),
	...
	public ArrayList<AdvisorType> getAllAdvisorType() {
		...
		Cursor cursor = mDb.query(TableAdvisorType, AdvisorType, null, null, null, null, null);
	...
	public ArrayList<Executertype> getAllExecutertype() {
		...
		Cursor cursor = mDb.query(TableExecutertype, Executertype, null, null, null, null, null);
	...
	public ArrayList<News> getAllNews() {
		...
		Cursor cursor = mDb.query(TableNews, News, null, null, null, null, null);
		News tempNews;
		while (cursor.moveToNext()) {
			tempNews = new News(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3),
					cursor.getInt(4));
			result.add(tempNews);
		}
	...
	public News getNewsById(int Id) {
		News item = null;
		Cursor mnew = mDb.query("News", News, " Id=?", new String[] { String.valueOf(Id) }, null, null, null);
	...
	public ArrayList<NewsPaper> getAllNewsPaper() {
		...
		Cursor cursor = mDb.query(TableNewsPaper, NewsPaper, null, null, null, null, null);
	...
	public ArrayList<ListItem> getListItemsById(int ListId) {
		...
		ListItem item = null;
		Cursor mCur = mDb.query("ListItem", ListItem, "ListId=?", new String[] { String.valueOf(ListId) }, null, null,
				null);
	...
	public ListItem getListItemById(int ListId) {
		...
		ListItem item = null;
		Cursor mCur = mDb.query("ListItem", ListItem, "Id=?", new String[] { String.valueOf(ListId) }, null, null,
				null);
	...
	public ArrayList<Anad> getAnadById(int ProvinceId) {
		...
		Anad item = null;
		Cursor mCur = mDb.query("Anad", Anad, "ProvinceId=?", new String[] { String.valueOf(ProvinceId) }, null, null,
				null);
	...
	public ArrayList<NewsPaper> getNewsPaperTypeId(int TypeId) {
		...
		ArrayList<NewsPaper> result = new ArrayList<NewsPaper>();
		NewsPaper item = null;
		Cursor mCur = mDb.query("NewsPaper", NewsPaper, "TypeId=?", new String[] { String.valueOf(TypeId) }, null, null,
				null);
	...
	public NewsPaper getNewsPaperId(int Id) {
		...
		NewsPaper item = null;
		Cursor mCur = mDb.query("NewsPaper", NewsPaper, "Id=?", new String[] { String.valueOf(Id) }, null, null, null);
	...
	public ArrayList<Ticket> getTicketByTypeId(int TypeId) {
		...
		Ticket item = null;
		Cursor mCur = mDb.query(TableTicket, Ticket, "TypeId=?", new String[] { String.valueOf(TypeId) }, null, null,
				null);
	...
	public Ticket getTicketById(int Id) {
		...
		Ticket item = null;
		Cursor mCur = mDb.query(TableTicket, Ticket, "Id=?", new String[] { String.valueOf(Id) }, null, null, null);
	...
	public Anad getAnadByid(int Id) {
		...
		Anad item = null;
		Cursor mCur = mDb.query(TableAnad, Anad, "Id=?", new String[] { String.valueOf(Id) }, null, null, null);
	...
	public ArrayList<Ticket> getFavoriteById(int TypeId, int provinceID) {
		...
		Cursor mCur = mDb.query(TableTicket, Ticket, "TypeId=? AND ProvinceId=?",
				new String[] { String.valueOf(TypeId), String.valueOf(provinceID) }, null, null, null);
	...
	public Favorite f(int Id) {
		...
		Favorite item = null;
		Cursor mCur = mDb.query(TableFavorite, Favorite, "Id=?", new String[] { String.valueOf(Id) }, null, null, null);
	...
	public Favorite getFavoriteByIdTicket(int Id) {
		...
		Favorite item = null;
		Cursor mCur = mDb.query(TableFavorite, Favorite, "IdTicket=?", new String[] { String.valueOf(Id) }, null, null,
				null);
	...
	public Object getObjectByname(String name) {
		...
		Object item = null;
		Cursor mCur = mDb.query(TableObject, Object, "Id=?", new String[] { String.valueOf(name) }, null, null, null);
	...
	public ArrayList<Ticket> getTicketByticketIduserId(int ticket, int user) {
		...
		Cursor mCur = mDb.query(TableTicket, Ticket, "Id=? AND UserId=?",
				new String[] { String.valueOf(ticket), String.valueOf(user) }, null, null, null);
	...
	public ArrayList<Anad> getAnadtByTypeIdProId(int provinceID) {
		...
		Cursor mCur = mDb.query(TableAnad, Anad, " ProvinceId=?", new String[] { String.valueOf(provinceID) }, null,
				null, null);
	...
	public ArrayList<Ticket> getTicketByProvinceId(int ProvinceId) {
		...
		ArrayList<Ticket> result = new ArrayList<Ticket>();
		Ticket item = null;
		Cursor mCur = mDb.query(TableTicket, Ticket, "ProvinceId=?", new String[] { String.valueOf(ProvinceId) }, null,
				null, null);
	...
	public ArrayList<City> getCitysByProvinceId(int ProvinceId) {
		...
		ArrayList<City> result = new ArrayList<City>();
		City item = null;
		Cursor mCur = mDb.query("City", CityColumn, "ProvinceId=?", new String[] { String.valueOf(ProvinceId) }, null,
				null, null);
	...
	public ArrayList<CommentInFroum> getseencomment(int userId) {
		...
		Cursor mCur = mDb.query(TableCommentInFroum, CommentInFroum, "seen=1 AND UserId=" + userId, null, null, null,
				null);
	...
	public ArrayList<CommentNotiItem> getUnseencomment(int userId) {
		...
		Cursor mCur = mDb.rawQuery(
				"select l.Id as commentId , f.Id,u.Name, f.Title, l.Date,l.Desk from CommentInFroum l inner join Froum f on l.FroumId=f.Id inner join Users u on u.Id = l.UserId where f.UserId ="
						+ userId + " AND f.UserId != l.UserId AND l.seen=0",
				null);

		CommentNotiItem noti;
		while (mCur.moveToNext()) {
			noti = new CommentNotiItem(mCur.getInt(0), mCur.getInt(1), mCur.getString(2), mCur.getString(3),
					mCur.getString(4), mCur.getString(5));
			result.add(noti);
		}
	...
	public ArrayList<LikeNotiItem> getUnseenlike(int userId) {
		...
		LikeNotiItem noti;
		while (mCur.moveToNext()) {
			noti = new LikeNotiItem(mCur.getInt(0), mCur.getInt(1), mCur.getString(2), mCur.getString(3),
					mCur.getString(4));
			result.add(noti);
		}
	...
	private Province CursorToProvince(Cursor cursor) {
		Province tempProvince = new Province(cursor.getInt(0), cursor.getString(1), cursor.getInt(2));
		return tempProvince;
	...
	private Users CursorToUsers(Cursor cursor) {
		...
		Users Users = new Users(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3),
				...
				cursor.getInt(9), cursor.getString(10), cursor.getString(11), cursor.getInt(12), cursor.getInt(13),
	...
	private LikeInFroum CursorToLikeInFroum(Cursor cursor) {
		com.project.mechanic.entity.LikeInFroum temp = new com.project.mechanic.entity.LikeInFroum(cursor.getInt(0),
				cursor.getInt(1), cursor.getInt(2), cursor.getString(3), cursor.getInt(4), cursor.getInt(5));
		return temp;

	}

	private LikeInPaper CursorToLikeInPaper(Cursor cursor) {
		LikeInPaper temp = new LikeInPaper(cursor.getInt(0), cursor.getInt(1), cursor.getInt(2), cursor.getString(3),
	...
	private City CursorToCity(Cursor cursor) {
		City tempCity = new City(cursor.getInt(0), cursor.getString(1), cursor.getInt(2), cursor.getInt(3));
		return tempCity;
	}
	...
	private Object CursorToObject(Cursor cursor) {
		...
		Object tempObject = new Object(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3),
				cursor.getString(4), cursor.getString(5), cursor.getBlob(6), cursor.getBlob(7), cursor.getBlob(8), null,
				cursor.getString(10), cursor.getString(11), cursor.getString(12), cursor.getString(13),
				cursor.getString(14), cursor.getString(15), cursor.getInt(16), cursor.getInt(17), cursor.getString(18),
				cursor.getString(19), cursor.getString(20), cursor.getString(21), cursor.getString(22),
				cursor.getString(23), cursor.getInt(24), cursor.getInt(25), cursor.getInt(26), cursor.getString(27),
				cursor.getInt(28), cursor.getInt(29), cursor.getInt(30), cursor.getInt(31), cursor.getInt(32),
	...
	private NewsPaper CursorToNewsPaper(Cursor cursor) {
		NewsPaper tempNewsPaper = new NewsPaper(cursor.getInt(0), cursor.getString(1), cursor.getInt(2),
				cursor.getString(3), cursor.getString(4), cursor.getString(5));
		return tempNewsPaper;
	}

	private AdvisorType CursorToAdvisorType(Cursor cursor) {
		AdvisorType tempAdvisorType = new AdvisorType(cursor.getInt(0), cursor.getString(1));
	...
	private Favorite CursorToFavorite(Cursor cursor) {
		Favorite temp = new Favorite(cursor.getInt(0), cursor.getInt(1), cursor.getInt(2), cursor.getInt(3),
				cursor.getInt(4));
		return temp;
	}
	...
	// private PostTimeline CursorToPostTimeline(Cursor cursor) {
	// PostTimeline tempPostTimeLine = new PostTimeline(cursor.getInt(0),
	...
	private News CursorToNews(Cursor cursor) {
		News tempNews = new News(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3),
				cursor.getInt(4));
		return tempNews;

	}

	private ExtraSettings CursorExtraSettings(Cursor cursor) {

		ExtraSettings tempNews = new ExtraSettings(cursor.getInt(0), cursor.getString(1), cursor.getString(2));
	...
	private CommentInObject CursorToCommentInObject(Cursor cursor) {
		CommentInObject tempNews = new CommentInObject(cursor.getInt(0), cursor.getString(1), cursor.getInt(2),
				cursor.getInt(3), cursor.getString(4), cursor.getInt(5), cursor.getInt(6), cursor.getInt(7),
				cursor.getInt(8));
		return tempNews;
	}

	private Ticket CursorToTicket(Cursor cursor) {
		Ticket tempTicket = new Ticket(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getInt(3),
				cursor.getBlob(4), cursor.getString(5), cursor.getInt(6), cursor.getInt(7), cursor.getInt(8),
				cursor.getInt(9), cursor.getInt(10), cursor.getInt(11), cursor.getInt(12), cursor.getString(13),
				cursor.getString(14), cursor.getString(15), cursor.getString(16), cursor.getString(17),
				cursor.getBlob(18), cursor.getString(19), cursor.getInt(20), cursor.getInt(21), cursor.getInt(22),
				cursor.getInt(23), cursor.getString(24), cursor.getString(25), cursor.getInt(26));
	...
	private Favorite CursorFavorite(Cursor cursor) {
		Favorite tempFavorite = new Favorite(cursor.getInt(0), cursor.getInt(1), cursor.getInt(2), cursor.getInt(3),
				cursor.getInt(4));
	...
	public Integer LikeInFroum_count(int froumID) {
		...
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableLikeInFroum + " WHERE FroumId=" + froumID, null);
		int res = 0;
		if (cu.moveToNext()) {
			res = cu.getInt(0);
		}
	...
	public Integer LikeInPost_count(int postID) {
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableLikeInPost + " WHERE PostId=" + postID, null);
		int res = 0;
		if (cu.moveToNext()) {
			res = cu.getInt(0);
		}
	...
	public Integer LikeInPaper_count(int paperID) {
		...
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableLikeInPaper + " WHERE PaperId=" + paperID, null);
		int res = 0;
		if (cu.moveToNext()) {
			res = cu.getInt(0);
		}
	...
	public Integer CommentInObject_count(int ObjectID) {
		...
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableCommentInObject + " WHERE ObjectId= " + ObjectID
	...
	public Integer CommentInFroum_count(int froumID) {
		...
		Cursor cu = mDb.rawQuery(
				"Select count(*) as co from " + TableCommentInFroum + " WHERE FroumId=" + froumID + " AND CommentID=0",
				null);
		int res = 0;
		if (cu.moveToNext()) {
			res = cu.getInt(0);
	...
	public Integer CommentInPost_count(int postID) {
		Cursor cu = mDb.rawQuery(
				"Select count(*) as co from " + TableCommentInPost + " WHERE PostId=" + postID + " AND CommentID=0",
				null);
		int res = 0;
		if (cu.moveToNext()) {
			res = cu.getInt(0);
	...
	public Integer CommentInPaper_count(int paperID) {
		...
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableCommentInPaper + " WHERE PaperId=" + paperID,
				null);
		int res = 0;
		if (cu.moveToNext()) {
			res = cu.getInt(0);
	...
	public ArrayList<LikeInPaper> getLikeInPaperByUserId(int UserID) {
		...
		Cursor cursor = mDb.query(TableLikeInPaper, LikeInPaper, " UserId=?", new String[] { String.valueOf(UserID) },
				null, null, null);
	...
	public ArrayList<CommentInFroum> getCommentInFroumbyPaperid(int Froumid, int commentID) {
	...
	public ArrayList<CommentInPost> getCommentInPostbyPostid(int Postid, int commentID) {
	...
	public ArrayList<CommentInFroum> getReplyCommentbyCommentID(int Froumid, int Commentid) {
	...
	public ArrayList<CommentInPost> getReplyCommentbyCommentIDPost(int Postid, int Commentid) {
	...
	public CommentInFroum getCommentInFroumbyID(int ID) {
		...
		Cursor mCur = mDb.query(TableCommentInFroum, CommentInFroum, "ID=?", new String[] { String.valueOf(ID) }, null,
				null, null);
	...
	public CommentInObject getCommentInObjectbyID(int ID) {
		...
		Cursor mCur = mDb.query(TableCommentInObject, CommentInObject, "Id=?", new String[] { String.valueOf(ID) },
				null, null, null);
	...
	public CommentInPaper getCommentInPaperbyID(int ID) {
		...
		Cursor mCur = mDb.query(TableCommentInPaper, CommentInPaper, "Id=?", new String[] { String.valueOf(ID) }, null,
				null, null);
	...
	public boolean isUserLikedComment(int userId, int CommentId, int isLike) {
		...
		Cursor curs = mDb.rawQuery("SELECT COUNT(*) AS NUM FROM " + TableLikeInComment + " WHERE UserId= "
				+ String.valueOf(userId) + " AND CommentId=" + String.valueOf(CommentId) + " AND IsLike=" + isLike,
				null);
		if (curs.moveToNext()) {
			int number = curs.getInt(0);
			if (number > 0)
	...
	public boolean isUserLikedCommentPost(int userId, int CommentId, int isLike) {

		Cursor curs = mDb.rawQuery("SELECT COUNT(*) AS NUM FROM " + TableLikeInCommentPost + " WHERE UserId= "
				+ String.valueOf(userId) + " AND CommentId=" + String.valueOf(CommentId) + " AND IsLike=" + isLike,
				null);
		if (curs.moveToNext()) {
			int number = curs.getInt(0);
	...
	public boolean isUserFavorite(int userId, int TicketId) {
		...
		Cursor curs = mDb.rawQuery("SELECT COUNT(*) AS NUM FROM " + TableFavorite + " WHERE UserId= "
				+ String.valueOf(userId) + " AND IdTicket=" + String.valueOf(TicketId), null);
		if (curs.moveToNext()) {
			int number = curs.getInt(0);
			if (number > 0)
				return true;
	...
	public boolean isUserDisLikedComment(int userId, int CommentId) {
		...
		Cursor curs = mDb.rawQuery("SELECT COUNT(*) AS NUM FROM " + TableLikeInComment + " WHERE UserId= "
				+ String.valueOf(userId) + " AND CommentId=" + String.valueOf(CommentId) + " AND IsLike=" + "0", null);
		if (curs.moveToNext()) {
			int number = curs.getInt(0);
			if (number > 0)
				return true;
...

	{
		...
		Cursor mCur = mDb.query(TableUsers, Users, "Mobailenumber=?", new String[] { mobailenumber }, null, null, null);
		if (mCur.moveToNext()) {
	...
	public Users getUserbyid(int id) {
		...
		Cursor mCur = mDb.query(TableUsers, Users, " ID=?", new String[] { String.valueOf(id) }, null, null, null);
		if (mCur.moveToNext()) {
			result = CursorToUsers(mCur);
		}
		return result;
	...
	public Froum getFroumItembyid(int Id) {
		...
		Froum item = null;
		Cursor mCur = mDb.query(TableFroum, Froum, " Id=?", new String[] { String.valueOf(Id) }, null, null, null);
	...
	public Post getPostItembyid(int Id) {
		...
		Post item = null;
		Cursor mCur = mDb.query(TablePost, Post, " Id=?", new String[] { String.valueOf(Id) }, null, null, null);
	...
	public Paper getPaperItembyid(int Id) {
		...
		Paper item = null;
		Cursor mCur = mDb.query(TablePaper, Paper, " Id=?", new String[] { String.valueOf(Id) }, null, null, null);
	...
	public ArrayList<Post> getAllPost(int objectId) {
		ArrayList<Post> result = new ArrayList<Post>();
		// Cursor cursor = mDb.query(TablePost, Post, " UserId=?",
		// new String[] { String.valueOf(UserID) }, null, null, null);
		// Cursor cursor = mDb
		// .query(TablePost, Post, null, null, null, null, null);
		Cursor cursor = mDb.query(TablePost, Post, " ObjectId=?", new String[] { String.valueOf(objectId) }, null, null,
				"Date DESC");
		while (cursor.moveToNext()) {
	...
	public ArrayList<PostTimeline> getAllTimeline(int UserID) {
		...
		String MY_QUERY = "SELECT Post.Id AS PostId, Post.UserId AS PostUserId, Post.Description AS PostDescription, Post.Seen AS PostSeen, Post.serverDate AS PostserverDate, Post.Submit AS PostSubmit, Post.Date AS PostDate, Post.SeenBefore AS PostSeenBefore, Post.Photo AS PostPhoto,"
				+ "Object.Id AS ObjectId,Object.ImagePath2 AS ObjectImagePath2,Object.Name AS ObjectName,"
				+ "LikeInObject.Id AS LikeInObjectId,LikeInObject.UserId AS LikeInObjectUserId,LikeInObject.PaperId AS LikeInObjectPaperId FROM Post "
				+ "INNER JOIN LikeInObject ON LikeInObject.PaperId = Post.ObjectId "
				+ "INNER JOIN Object ON Object.Id = LikeInObject.PaperId " + "WHERE LikeInObject.UserId="
				+ String.valueOf(UserID) + " ORDER BY Post.Id DESC";// LIMIT 5
		Cursor cursor = mDb.rawQuery(MY_QUERY, null);

		Toast.makeText(mContext, UserID + " — " + cursor.getCount() + "", Toast.LENGTH_SHORT).show();

		while (cursor.moveToNext()) {

			String ObjectImagePath2 = cursor.getString(cursor.getColumnIndex("ObjectImagePath2"));
			String PostDescription = (String) cursor.getString(cursor.getColumnIndex("PostDescription"));
			String PostserverDate = cursor.getString(cursor.getColumnIndex("PostserverDate"));
			String PostDate = cursor.getString(cursor.getColumnIndex("PostDate"));
			String PostPhoto = cursor.getString(cursor.getColumnIndex("PostPhoto"));
			String ObjectName = cursor.getString(cursor.getColumnIndex("ObjectName"));

			if (ObjectImagePath2 == null)
				ObjectImagePath2 = "";
			if (PostDescription == null)
				PostDescription = "";
			if (PostserverDate == null)
				PostserverDate = "";
			if (PostDate == null)
				PostDate = "";
			if (PostPhoto == null)
			...
			PostTimeline ArrayPostTimeLine = new PostTimeline(cursor.getInt(cursor.getColumnIndex("PostId")),
					cursor.getInt(cursor.getColumnIndex("PostUserId")), PostDescription,
					cursor.getInt(cursor.getColumnIndex("PostSeen")), PostserverDate,
					cursor.getInt(cursor.getColumnIndex("PostSubmit")), PostDate,
					cursor.getInt(cursor.getColumnIndex("PostSeenBefore")), PostPhoto,
					cursor.getInt(cursor.getColumnIndex("ObjectId")), ObjectImagePath2, ObjectName,
					cursor.getInt(cursor.getColumnIndex("LikeInObjectId")),
					cursor.getInt(cursor.getColumnIndex("LikeInObjectUserId")),
					cursor.getInt(cursor.getColumnIndex("LikeInObjectPaperId")));

			result.add(ArrayPostTimeLine);
		}
	...
	public ArrayList<Ticket> getAllTicket() {
		ArrayList<Ticket> result = new ArrayList<Ticket>();
		Cursor cursor = mDb.query(TableTicket, Ticket, null, null, null, null, null);
		while (cursor.moveToNext()) {
	...
	public ArrayList<TicketType> getAllTicketType() {
		...
		Cursor cursor = mDb.query(TableTicketType, TicketType, null, null, null, null, null);
		while (cursor.moveToNext()) {
	...
	public ArrayList<Anad> getAllAnad() {
		ArrayList<Anad> result = new ArrayList<Anad>();
		Cursor cursor = mDb.query(TableAnad, Anad, null, null, null, null, null);
		while (cursor.moveToNext()) {
	...
	public ArrayList<Users> getUserOfcomment(String froumId) {
		...
		Cursor cursor = mDb.rawQuery(
				"Select " + Users[0] + "," + Users[1] + "," + Users[2] + "," + Users[3]
						+ "  From Users inner join Comment on User.id=Comment.UserId where Comment.PaperId =" + froumId,
				null);
		while (cursor.moveToNext()) {
			Users tempusers = new Users(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3),
					cursor.getString(4), cursor.getString(5), cursor.getString(6), cursor.getString(7),
					cursor.getBlob(8), cursor.getInt(9), cursor.getString(10), cursor.getString(11), cursor.getInt(12),
					cursor.getInt(13), cursor.getString(14), cursor.getString(15), cursor.getString(16),
					cursor.getString(17), cursor.getInt(18));
			;
	...
	private CommentInFroum CursorToCommentInFroum(Cursor cursor) {
		CommentInFroum tempComment = new CommentInFroum(cursor.getInt(0), cursor.getString(1), cursor.getInt(2),
				cursor.getInt(3),
	...
	private CommentInPost CursorToCommentInPost(Cursor cursor) {
		CommentInPost tempComment = new CommentInPost(cursor.getInt(0), cursor.getString(1), cursor.getInt(2),
				cursor.getInt(3),
	...
	private CommentInPaper CursorToCommentInPaper(Cursor cursor) {
		CommentInPaper tempComment = new CommentInPaper(cursor.getInt(0), cursor.getString(1), cursor.getInt(2),
	...
	public int getNumberOfListItemChilds(int parentId) {
		int res = 0;
		Cursor cursor = mDb.rawQuery("Select Count(*) From " + TableListItem + " Where ListId= " + parentId, null);
		if (cursor.moveToNext()) {
			res = cursor.getInt(0);
		}
	...
	public void UpdateObjectProperties(int id, String name, String Phone, String Email, String fax, String description,
			String LinkCatalog, String LinkPrice, String LinkPDF, String LinkVideo, String Address, String Mobile,
			String LinkFaceBook, String LinkInstagram, String LinkLinkedin, String LinkGoogle, String LinkSite,
			String LinkTweitter, int ObjectBrandTypeId) {
		...
		uc.put("ObjectBrandTypeId", ObjectBrandTypeId);

		mDb.update(TableObject, uc, "Id=" + id, null);
		Toast.makeText(mContext, "اطلاعات با موفقیت ویرایش شد", Toast.LENGTH_SHORT).show();
	}
	...
	public void InsertInformationNewObject(int id, String name, String Phone, String Email, String fax,
			String description, String LinkCatalog, String LinkPrice, String LinkPDF, String LinkVideo, String Address,
			String Mobile, String LinkFaceBook, String LinkInstagram, String LinkLinkedin, String LinkGoogle,
			String LinkSite, String LinkTweitter, int userId, int parentId, int MainObjectId, int ObjectId,
			int ObjectBrandTypeId, int AgencyService, String Date) {
	...
	public City getCityById(int id) {
		City item = null;
		Cursor mCur = mDb.query(TableCity, CityColumn, " Id=?", new String[] { String.valueOf(id) }, null, null, null);
	...
	public Province getProvinceById(int id) {
		Province item = null;
		Cursor mCur = mDb.query(TableProvince, Province, " Id=?", new String[] { String.valueOf(id) }, null, null,
				null);
	...
	public Object getObjectByName(String name) {
		Object item = null;
		Cursor mCur = mDb.query(TableObject, Object, " Name=?", new String[] { String.valueOf(name) }, null, null,
				null);
	...
	public Integer getCountofCommentinFroumObject(int froumID, int CommentID) {
		...
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableCommentInFroum + " WHERE FroumId=" + froumID
	...
	public void deleteLikeFromCommentInFroum(int CommentID, int userID, int isLike) {
		String[] t = { String.valueOf(CommentID), String.valueOf(userID), String.valueOf(isLike) };
		mDb.delete(TableLikeInComment, "CommentId=? and UserId =? and IsLike =?", t);
	}

	public void deleteLikeFromCommentInPost(int CommentID, int userID, int isLike) {
		String[] t = { String.valueOf(CommentID), String.valueOf(userID), String.valueOf(isLike) };
		mDb.delete(TableLikeInCommentPost, "CommentId=? and UserId =? and IsLike =?", t);
	}

	public int NumOfNewLikeInObject(int userId) {
		int res = 0;
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableLikeInObject + " as l inner join " + TableObject
				+ " as f on f.Id = l.PaperId WHERE l.Seen=0 AND f.UserId=" + userId, null);
		if (cu.moveToNext()) {
			res = cu.getInt(0);
		}
		return res;
	...
	public int NumOfNewLikeInPaper(int userId) {
		int res = 0;
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableLikeInPaper + " as l inner join " + TablePaper
				+ " as f on f.Id = l.PaperId WHERE l.Seen=0 AND f.UserId=" + userId, null);
		if (cu.moveToNext()) {
			res = cu.getInt(0);
		}
	...
	public int NumOfNewLikeInFroum(int userId) {
		int res = 0;
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableLikeInFroum + " as l inner join " + TableFroum
				+ " as f on f.Id = l.FroumId WHERE l.Seen=0 AND f.UserId=" + userId, null);
		if (cu.moveToNext()) {
			res = cu.getInt(0);
		}
		return res;
	...
	public int NumOfNewCmtInObject(int userId) {
		int res = 0;
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableCommentInObject + " as l inner join "
				+ TableObject + " as f on f.Id = l.ObjectId WHERE l.Seen=0 AND f.UserId=" + userId, null);
		if (cu.moveToNext()) {
			res = cu.getInt(0);
		}
		return res;
	...
	public int NumOfNewCmtInPaper(int userId) {
		int res = 0;
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableCommentInPaper + " as l inner join " + TablePaper
				+ " as f on f.Id = l.PaperId WHERE l.Seen=0 AND f.UserId=" + userId, null);
		if (cu.moveToNext()) {
			res = cu.getInt(0);
		}
	...
	public int NumOfNewCmtInFroum(int userId) {
		int res = 0;
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableCommentInFroum + " as l inner join " + TableFroum
				+ " as f on f.Id = l.FroumId WHERE l.Seen=0 AND f.UserId=" + userId, null);
		if (cu.moveToNext()) {
			res = cu.getInt(0);
		}
	...
	public Users getCurrentUser() {
		Users u = null;
		Cursor mCur = mDb.query(TableUsers, Users, " admin=1", null, null, null, null);
		if (mCur.moveToNext()) {
	...
	public Integer Mechanical_serach(String word, String field) {
		...
		if (field.equals("Name")) {
			...
			cu = mDb.rawQuery("select * from Province  where " + field + " Like '%" + word + "%'", null);
		}
	...
	public Integer getCountOfReplyInPost(int postID, int commentID) {
		...
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableCommentInPost + " WHERE PostId=" + postID
				+ " AND CommentID= " + commentID, null);
		int res = 0;
		if (cu.moveToNext()) {
			res = cu.getInt(0);
	...
	public boolean isUserLikeIntroductionPage(int userId, int ObjectId, int CommentId) {
	...
	public boolean isUserHappyFromPage(int userId, int ObjectId, int isLike) {
	...
	public void putLikeOrDisLikeIntroduction(int id, String numofLike, int UserId) {
		if (!isUserLikedComment(UserId, id, 1)) {
			ContentValues uc = new ContentValues();
			uc.put("NumOfLike", numofLike);
	...
	public void updateTables(String tableName, String[] cols, String[][] values, String startModifyDate,
			String endModifyDate) {
		...
		for (int i = 0; i < values.length; i++) {
			...
			try {
				if (cv.size() > 0) {
					mDb.insertWithOnConflict(tableName, null, cv, SQLiteDatabase.CONFLICT_ABORT);
				}
	...
	public Settings getSettings() {
		Settings set = null;
		Cursor cur = mDb.query(TableSettings, Settings, null, null, null, null, null);
		if (cur.moveToNext())
	...
	public void CreatePageInShopeObject(int id, String name, String Phone, String Email, String fax, String description,
			String LinkCatalog, String LinkPrice, String LinkPDF, String LinkVideo, String Address, String Mobile,
			String LinkFaceBook, String LinkInstagram, String LinkLinkedin, String LinkGoogle, String LinkSite,
			String LinkTweitter, int userId, int MainObjectId, int ObjectBrandTypeId, int AdvisorTypeId) {
	...
	public LikeInFroum getLikeInFroumById(int id) {
		LikeInFroum lk = null;
		Cursor cur = mDb.query(TableLikeInFroum, LikeInFroum, "Id=?", new String[] { String.valueOf(id) }, null, null,
				null);
		if (cur.moveToNext())
	...
	public LikeInObject getLikeInObjectById(int id) {
		...
		Cursor cur = mDb.query(TableLikeInObject, LikeInObject, "Id=?", new String[] { String.valueOf(id) }, null, null,
				null);
		if (cur.moveToNext())
	...
	public LikeInPaper getLikeInPaperById(int id) {
		LikeInPaper lk = null;
		Cursor cur = mDb.query(TableLikeInPaper, LikeInPaper, "Id=?", new String[] { String.valueOf(id) }, null, null,
				null);
		if (cur.moveToNext())
	...
	public void InsertLikeCommentFroumToDatabase(int id, int UserId, int ISLike, int CommentId, String date) {
	...
	public void InsertLikeCommentPostToDatabase(int id, int UserId, int ISLike, int CommentId, String date) {
		...
		mDb.insert(TableLikeInCommentPost, null, uc);
	}

	public void insertLikeCommentPost(int id, int UserId, int ISLike, int CommentId, String date) {
	...
	public Integer NumberOfLikeOrDisLikeFroum(int commentID, int isLike) {
		...
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableLikeInComment + " WHERE CommentID=" + commentID
	...
	public Integer NumberOfLikeOrDisLikePost(int commentID, int isLike) {
		...
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableLikeInCommentPost + " WHERE CommentID="
				+ commentID + " AND isLike = " + isLike, null);
		int res = 0;
		if (cu.moveToNext()) {
			res = cu.getInt(0);
		}
	...
	public ArrayList<Object> subBrandObject(int ObjectId, int CityId, int AgencyService) {
		ArrayList<Object> result = new ArrayList<Object>();
		Cursor cursor = mDb.rawQuery(
	...
	public ArrayList<LikeInFroum> getLikefroumLikeInFroumByFroumId(int FroumId) {
		...
		Cursor cursor = mDb.rawQuery("select * from LikeInFroum where FroumId =  " + FroumId, null);

		LikeInFroum like;
		while (cursor.moveToNext()) {
			like = new LikeInFroum(cursor.getInt(0), cursor.getInt(1), cursor.getInt(2), cursor.getString(3),
					cursor.getInt(4), cursor.getInt(5));
	...
	public ArrayList<LikeInPost> getLikepostLikeInPostByPostId(int PostId) {
		...
		Cursor cursor = mDb.rawQuery("select * from LikeInPost where PostId =  " + PostId, null);

		LikeInPost like;
		while (cursor.moveToNext()) {
			like = new LikeInPost(cursor.getInt(0), cursor.getInt(1), cursor.getInt(2), cursor.getString(3),
					cursor.getInt(4), cursor.getInt(5));
	...
	public ArrayList<LikeInPaper> getLikePaperByPaperId(int PaperID) {
		ArrayList<LikeInPaper> result = new ArrayList<LikeInPaper>();
		Cursor cursor = mDb.rawQuery("select * from LikeInPaper where PaperId =  " + PaperID, null);

		LikeInPaper like;
		while (cursor.moveToNext()) {
			like = new LikeInPaper(cursor.getInt(0), cursor.getInt(1), cursor.getInt(2), cursor.getString(3),
					cursor.getInt(4), cursor.getInt(5));
	...
	public void InsertLikeCommentFromObject(int id, int UserId, int ISLike, int CommentId, String Date) {
	...
	public boolean isUserLikedCommentBrandPage(int userId, int CommentId, int isLike) {

		Cursor curs = mDb.rawQuery("SELECT COUNT(*) AS NUM FROM " + TableLikeInCommentObject + " WHERE UserId= "
				+ userId + " AND CommentId=" + CommentId + " AND IsLike=" + isLike, null);
		if (curs.moveToNext()) {
			int number = curs.getInt(0);
			if (number > 0)
				return true;
	...
	public void deleteLikeCommentBrandPage(int CommentID, int userID, int isLike) {
		String[] t = { String.valueOf(CommentID), String.valueOf(userID), String.valueOf(isLike) };
		mDb.delete(TableLikeInCommentObject, "CommentId=? and UserId =? and IsLike =?", t);
	}

	public Integer NumberOfLikeOrDisLikeBrandPage(int commentID, int isLike) {

		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableLikeInCommentObject + " WHERE CommentID="
				+ commentID + " AND isLike = " + isLike, null);
		int res = 0;
		if (cu.moveToNext()) {
			res = cu.getInt(0);
	...
	public ArrayList<LikeInObject> getAllLikeFromObject(int ObjectId, int CommentId) {
		...
		LikeInObject like;
		while (cursor.moveToNext()) {
			like = new LikeInObject(cursor.getInt(0), cursor.getInt(1), cursor.getInt(2), cursor.getString(3),
	...
	public void UpdateImageObjectToDatabase(int id, byte[] HeaderImage, byte[] ProfileImage, byte[] FooterImage) {
	...
	public void UpdateFooterImageObject(int id, byte[] footer) {
		...
		Toast.makeText(mContext, "تصویر با موفقیت ثبت شد", Toast.LENGTH_SHORT).show();
		mDb.update(TableObject, cv, "Id=?", new String[] { String.valueOf(id) });
	}

	public ArrayList<com.project.mechanic.entity.SubAdmin> getAllAdmin(int ObjectId) {
		ArrayList<com.project.mechanic.entity.SubAdmin> result = new ArrayList<com.project.mechanic.entity.SubAdmin>();
		Cursor cursor = mDb.query(TableSubAdmin, SubAdmin, "ObjectId = " + ObjectId, null, null, null, null);
		com.project.mechanic.entity.SubAdmin tempObject;
		while (cursor.moveToNext()) {
			tempObject = new com.project.mechanic.entity.SubAdmin(cursor.getInt(0), cursor.getInt(1), cursor.getInt(2),
	...
	public void insertSubAdminPage(int Id, int ObjectId, int UserId, int AdminId, String date) {
	...
	public ArrayList<SubAdmin> getAdmin(int ObjectId) {
		...
		Cursor cursor = mDb.rawQuery("select *from SubAdmin where ObjectId = " + ObjectId, null);
		SubAdmin tempNews;
		while (cursor.moveToNext()) {
			tempNews = new SubAdmin(cursor.getInt(0), cursor.getInt(1), cursor.getInt(2), cursor.getInt(3),
					cursor.getString(4));
			result.add(tempNews);
		}
	...
	public boolean IsUserAdmin(int userId, int objectId) {
		...
		Cursor curs = mDb.rawQuery("SELECT COUNT(*) AS NUM FROM " + TableSubAdmin + " WHERE UserId= "
				+ String.valueOf(userId) + " AND ObjectId =" + String.valueOf(objectId), null);
		if (curs.moveToNext()) {
			int number = curs.getInt(0);
			if (number > 0)
				return true;
	...
	public void updateAllImageIntroductionPage(int id, byte[] HeaderImage, byte[] ProfileImage, byte[] FooterImage) {
		ContentValues uc = new ContentValues();
	...
	public Integer countSubAdminPage(int ObjectID) {
		...
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableSubAdmin + " WHERE ObjectId=" + ObjectID, null);
		int res = 0;
		if (cu.moveToNext()) {
			res = cu.getInt(0);
		}
	...
	public void deleteLikeInCommentFroum(int froumId) {
		mDb.execSQL("delete from [LikeInComment] where CommentId = " + froumId);
	...
	public void deleteReplyCommentInObject(int id) {
		mDb.execSQL("delete from [CommentInObject] where CommentId = " + id);

	}

	public void deleteOnlyReplyPost(int id) {
		mDb.execSQL("delete from [CommentInPost] where Id = " + id);

	}

	public void deleteOnlyReplyFroum(int id) {
		mDb.execSQL("delete from [CommentInFroum] where Id = " + id);
	...
	public Integer countSubAgencyBrand(int ObjectID) {
		...
		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TableObject + " WHERE ObjectId=" + ObjectID, null);
		int res = 0;
		if (cu.moveToNext()) {
			res = cu.getInt(0);
		}
	...
	public ArrayList<Object> getObjectByuserId(int id) {
		...
		Cursor mCur = mDb.query(TableObject, Object, "userId=?", new String[] { String.valueOf(id) }, null, null, null);
	...
	public ArrayList<String> getNameObjectById(int userId) {
		ArrayList<String> result = new ArrayList<String>();
		Cursor mCur = mDb.query(TableObject, Object, "userId=?", new String[] { String.valueOf(userId) }, null, null,
				null);
		if (mCur.moveToNext()) {
	...
	public ArrayList<Object> getAllObjectByUserId(int id) {
		...
		ArrayList<Object> result = new ArrayList<Object>();
		Cursor cursor = mDb.query(TableObject, Object, "userId=?", new String[] { String.valueOf(id) }, null, null,
				null);
		Object tempObject;
		while (cursor.moveToNext()) {
			tempObject = new Object(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3),
	...
	public ArrayList<Ticket> getAllTicketUser(int userId) {
		...
		Ticket tempTicket;
		while (cursor.moveToNext()) {
			tempTicket = new Ticket(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getInt(3),
					cursor.getBlob(4), cursor.getString(5), cursor.getInt(6), cursor.getInt(7), cursor.getInt(8),
					cursor.getInt(9), cursor.getInt(10), cursor.getInt(11), cursor.getInt(12), cursor.getString(13),
					cursor.getString(14), cursor.getString(15), cursor.getString(16), cursor.getString(17),
					cursor.getBlob(18), cursor.getString(19), cursor.getInt(20), cursor.getInt(21), cursor.getInt(22),
	...
	public ArrayList<Paper> getAllPaperUser(int userId) {
		...
		ArrayList<Paper> result = new ArrayList<Paper>();
		Cursor cursor = mDb.query(TablePaper, Paper, "userId=?", new String[] { String.valueOf(userId) }, null, null,
				null);
		Paper tempTicket;
		while (cursor.moveToNext()) {
	...
	public ArrayList<Froum> getAllFroumUser(int userId) {
		...
		ArrayList<Froum> result = new ArrayList<Froum>();
		Cursor cursor = mDb.query(TableFroum, Froum, "userId=?", new String[] { String.valueOf(userId) }, null, null,
				null);
		Froum temp;
		while (cursor.moveToNext()) {
	...
	public Froum getFroumByUserId(int userId) {
		...
		Froum item = null;
		Cursor mCur = mDb.query(TableFroum, Froum, " UserId=?", new String[] { String.valueOf(userId) }, null, null,
				null);
	...
	public boolean IsUserFavoriteItem(int userId, int TicketId, int type) {
		...
		Cursor curs = mDb
				.rawQuery(
						"SELECT COUNT(*) AS NUM FROM " + TableFavorite + " WHERE UserId= " + String.valueOf(userId)
								+ " AND IdTicket=" + String.valueOf(TicketId) + " AND Type = " + String.valueOf(type),
						null);
		if (curs.moveToNext()) {
			int number = curs.getInt(0);
			if (number > 0)
	...
	public ArrayList<Favorite> getFavoriteItem(int userId, int source) {
		...
		Cursor cursor = mDb.query(TableFavorite, Favorite, "UserId=? AND Type=?",
				new String[] { String.valueOf(userId), String.valueOf(source) }, null, null, null);
		Favorite temp;
		while (cursor.moveToNext()) {
	...
	public ArrayList<PersonalData> CustomFieldFavorite(int userId, int source) {
		...
		for (int i = 0; i < favList.size(); i++) {
			...
			case 4: {
				...
				// Post p = getPostItembyid(fav.getIdTickte());
				//
				// prd.setObjectId(p.getId());
				// prd.setNameObject(p.getName());
				// prd.setImagePathObject(p.getImagePath2());
				// prd.setDateObject(p.getDate());
	...
	public ArrayList<PersonalData> CustomFieldObjectFollowByUser(List<Object> objectList) {
	...
	public Integer CountPostUser(int ObjectId) {

		Cursor cu = mDb.rawQuery("Select count(*) as co from " + TablePost + " WHERE ObjectId= " + ObjectId, null);
		int res = 0;
		if (cu.moveToNext()) {
			res = cu.getInt(0);
		}
	...
	public void updateCountView(String tableName, int id, int value) {

		ContentValues uc = new ContentValues();
		uc.put("CountView", value);
		mDb.update(tableName, uc, "Id=" + id, null);
	}

	public Integer getCountVisitItem(int itemId, int typeId) {

		Cursor cu = mDb.rawQuery(
				"Select count(*) as co from " + TableVisit + " WHERE ObjectId=" + itemId + " AND TypeId=" + typeId,
				null);
		int res = 0;
		if (cu.moveToNext()) {
			res = cu.getInt(0);
	...
	public void insertPhotoPostToDB(int id, String ImageAdrress) {

		ContentValues cv = new ContentValues();

		cv.put("PostId", id);

		cv.put("Name", ImageAdrress);

		mDb.insert(TablePostPhoto, null, cv);

	}

	public void updateAnadItem(int id, int objectId) {
	...
	public void updateCountPost(int objectId, int count) {

		ContentValues uc = new ContentValues();
		uc.put("CountPost", count);

		mDb.update(TableObject, uc, "Id =" + objectId, null);

	}

	public void updateCountFollower(int objectId, int count) {

		ContentValues uc = new ContentValues();
		uc.put("CountFollower", count);
	...
	public void updatePositionScrollAnad(String position) {

		ContentValues uc = new ContentValues();

		uc.put("Key", "PositionScrollAnad");
		uc.put("Value", position);

		mDb.update(TableExtraSettings, uc, null, null);

	}

	public ExtraSettings getPositionScroll() {
		ExtraSettings set = null;
		Cursor cur = mDb.query(TableExtraSettings, extraSettings, null, null, null, null, null);
		if (cur.moveToNext())
			set = CursorExtraSettings(cur);
		return set;
