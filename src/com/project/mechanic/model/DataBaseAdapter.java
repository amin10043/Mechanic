...
public String getUserOfcomment(String froumId){
	String result = new String();
	Cursor cursor = mDb.rawQuery("Select Users.* From Users join Comment on User.id=Comment.UserId where Comment.PaperId = Froum.Id", null);
	Comment tempComment;
	while(cursor.moveToNext()){
